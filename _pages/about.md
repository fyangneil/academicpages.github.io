...
We are working on developing vision-based technology for automatic operating room and intelligent medical device. The involved computer vision topics include but not limit to object detection, moving object detection, 2D/3D human pose estimation or body mesh recovery, 3D dynamic scene perception. 
